...
- **POST /flashcards/:id/approve**
  ...
  - **Example Request:**
    ```
    POST /flashcards/123e4567-e89b-12d3-a456-426614174001/approve
    ```
  - **Response:** Flashcard object with status set to "accepted".
  - **Example Reply:**
    ```json
    {
      "id": "123e4567-e89b-12d3-a456-426614174001",
      ...
      "status": "accepted",
      "created_at": "2023-10-10T12:00:00Z",
      "last_reviewed": "2023-10-10T12:05:00Z",
      "next_review_date": "2023-10-15T12:00:00Z",
      "review_count": 0,
      "easiness_factor": 2.5,
      "interval": 0
  ...
  - **Errors:**
    - 404 Not Found: Flashcard not found.
    - 500 Internal Server Error: Error approving flashcard.

- **POST /flashcards/:id/reject**
  - **Description:** Mark a flashcard as rejected.
  - **Example Request:**
    ```
    POST /flashcards/123e4567-e89b-12d3-a456-426614174001/reject
    ```
  - **Response:** Flashcard object with status set to "rejected".
  - **Example Reply:**
    ```json
    {
      "id": "123e4567-e89b-12d3-a456-426614174001",
  ...
  - **Errors:**
    - 404 Not Found: Flashcard not found.
    - 500 Internal Server Error: Error rejecting flashcard.

- **POST /flashcards/:id/regenerate**
  - **Description:** Trigger regeneration of a flashcard if its content does not meet user criteria.
  - **Example Request:**
    ```
    POST /flashcards/123e4567-e89b-12d3-a456-426614174000/regenerate
    ```
  - **Response:** A new flashcard object generated based on the existing context.
  - **Example Reply:**
    ```json
    {
      ...
      "user_id": "user-uuid",
      "generation_id": "optional-uuid",
      "front": "Regenerated question text",
      "back": "Regenerated answer",
      "source": "ai-full",
      "status": "pending",
    ...
    ```
  - **Validations:**
    - Ensure the specified flashcard exists and is eligible for regeneration.
  - **Errors:**
    - 404 Not Found: Flashcard not found.
    - 400 Bad Request: Flashcard not eligible for regeneration.
    - 500 Internal Server Error: Error during flashcard regeneration.
